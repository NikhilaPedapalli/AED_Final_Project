...
public class PetHospitalManageEmployeeJPanel extends javax.swing.JPanel {

    private PetHospitalOrganizationDirectory organizationDir;
    private JPanel userProcessContainer;
    private EcoSystem system;    
    /**
     * Creates new form ManageOrganizationJPanel
     */
    public PetHospitalManageEmployeeJPanel(JPanel userProcessContainer,PetHospitalOrganizationDirectory organizationDir,EcoSystem system) {
        initComponents();
    ...
    public void populateOrganizationComboBox(){
        ...
        for (PetHospitalOrganization organization : organizationDir.getOrganizationList()){
    ...
    public void populateOrganizationEmpComboBox(){
        ...
        for (PetHospitalOrganization o : organizationDir.getOrganizationList()){
            organizationEmpJComboBox.addItem(o);
        }
    }

    private void populateTable(PetHospitalOrganization organization){
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        PetHospitalOrganization organization = (PetHospitalOrganization) organizationEmpJComboBox.getSelectedItem();
